...
#### [Root CA 의 비밀키와 짝을 이룰 공개키 생성]
openssl genrsa -out ca.key 4096

#### [Root CA 의 비밀키와 짝을 이룰 공개키 생성]
Common Name 항목은 Private registry domain 주소를 입력해줘야 함  
...
### 3. Server Certicates 생성
서버의 인증서를 생성  
Root CA의 비밀키와 공개키를 만들 때와 마찬가지로 서버의 비밀키를 생성하고, 생성한 비밀키를 넣어 CSR 파일을 생성함. 
