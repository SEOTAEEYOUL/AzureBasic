...
```
NAME: nginx-ingress
LAST DEPLOYED: Wed Dec  9 16:54:14 2020
NAMESPACE: ingress-basic
STATUS: deployed
REVISION: 1
TEST SUITE: None
...
nginx-ingress-ingress-nginx-controller   LoadBalancer   10.0.201.218   20.41.101.29   80:31340/TCP,443:32205/TCP   110m   app.kubernetes.io/component=controller,app.kubernetes.io/instance=nginx-ingress,app.kubernetes.io/name=ingress-nginx
```

## DNS 영역에 A 레코드 추가
```
az network dns record-set a add-record `
    --resource-group rg-vm-taeyeol `
    --zone-name paas-cloud.net `
    --record-set-name * `
    --ipv4-address 20.41.101.29
```
```
az network dns record-set a add-record --resource-group rg-vm-taeyeol --zone-name paas-cloud.net --record-set-name \*  --ipv4-address 20.41.101.29
{
  "arecords": [
    {
      "ipv4Address": "20.41.101.29"
    }
  ],
  "etag": "e37315b8-edbc-4e98-8a6b-f6ac61f35381",
  "fqdn": "*.paas-cloud.net.",
  "id": "/subscriptions/9ebb0d63-8327-402a-bdd4-e222b01329a1/resourceGroups/rg-vm-taeyeol/providers/Microsoft.Network/dnszones/paas-cloud.net/A/*",
  "metadata": null,
  "name": "*",
  "provisioningState": "Succeeded",
  "resourceGroup": "rg-vm-taeyeol",
  "targetResource": {
    "id": null
  },
  "ttl": 3600,
...
jetstack/cert-manager           v1.3.1          v1.3.1          A Helm chart for cert-manager
jetstack/cert-manager-istio-csr v0.1.2          v0.1.2          A Helm chart for istio-csr
```
