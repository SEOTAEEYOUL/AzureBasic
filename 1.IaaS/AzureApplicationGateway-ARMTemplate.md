# [빠른 시작: Azure Application Gateway를 통해 웹 트래픽 보내기 - ARM 템플릿](https://docs.microsoft.com/ko-kr/azure/application-gateway/quick-create-template)

![application-gateway-qs-resources.png](./img/application-gateway-qs-resources.png)  

## ARM 템플릿
- 프로젝트에 대한 인프라 및 구성을 정의하는 JSON(JavaScript Object Notation) 파일
- 선언적 구문을 사용
- 선언적 구문에서는 배포를 만들기 위한 프로그래밍 명령의 시퀀스를 작성하지 않고 의도하는 배포를 설명
